            ...
            <div class="formContainer">
                <div class="formAdd">
                    <form action="" method="post" class="form">
                        <div class="form">
                            <input placeholder="Nombre(s)" name="namePatient" value="<?php echo $name?>"
                                class="inputTextDesign" disabled/>
                            <input type="date" placeholder="Fecha" disabled name="patientDateUpdate" class="inputTextDesign"
                                value="<?php echo $fecha?>" />
                            <input type="time" placeholder="Hora" disabled name="patientTimeDateUpdate"
