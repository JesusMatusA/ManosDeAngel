                            ...
                            if($result->fetchColumn() > 0){
                                ...
                                foreach($connection->query($query) as $fila){
                                    ...
                                    <tr class="tableTRC">
                                        ...
                                        <td class="tableTDCL">
                                            <a class="link_a" href="AddDateScreen.php?Id=<?php echo $fila['Id_Paciente']?>">Notas</a>
                                            |
                                            <a class="link_a" href="UpdateClientScreen.php?Id=<?php echo $fila['Id_Paciente']?>">Datos</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
